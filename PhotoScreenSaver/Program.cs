...
namespace PhotoScreenSaver
{
    ...
    {
        //a screen saver receives command-line arguments which informs it which "mode" it should run in.
        //There are three arguments it might be passed in upper or lower case:
